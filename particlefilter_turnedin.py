...
def get_scan_prob(p):
    ...
    for i in range(len(laser_data.ranges)):
        ...
        expected_distance = distance_LUT.distance(p.x, p.y, angle)        
...
def resample_particles():
    ...
    for i in range(min_num_of_particles-num_of_rand_needed):
        part = Particle(new_particlesNumpy[i].x, new_particlesNumpy[i].y, new_particlesNumpy[i].theta, new_particlesNumpy[i].w)
