...
#This function looks at the current M3slaser reading, then computes and returns the obstacle avoidance force vector (in local robot coordinates)
def obstacle_force():  
    ...
    for i in range(len(laser_scan.ranges)):
        ...
        a_to_goal = (robot[2] + cur_angle - math.pi)
        a_to_goal= wrap_angle(a_to_goal)
        force_vector= [strength*math.cos(a_to_goal), strength*math.sin(a_to_goal)] 
